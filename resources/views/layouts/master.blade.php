  ...
  <div class="wrapper ">
    <div class="sidebar" data-color="orange"><!--Tip 1: You can change the color of the sidebar using: data-color="blue | green | orange | red | yellow"-->
      <div class="logo">
        ...
        <img src="images/log_png.png" class="img-fluid">
      </div>
      <div class="sidebar-wrapper" id="sidebar-wrapper">
        <ul class="nav">
            ...
            <a href="/admin">
              ...
              <p style="font-size: 18px">الإحصائيات</p>
            </a>
          </li>
          ...
          <li class="{{ 'role-register' == request()->path() ? 'active' : '' }}">
            <a href="/role-register">
              <i class="now-ui-icons users_single-02"></i>
              <p style="font-size: 18px">الطلبات</p>
            </a>
          </li>
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a style="font-size: 24px" class="navbar-brand" href="/">العودة للموقع</a>
          </div>
